...
PCPM_cost = (PCPM_material_costs + general_energy_cost) / PCPM_removal  # USD / % removal
PCPM_impacts = (PCPM_material_impacts + general_energy_impact) / PCPM_removal  # impact / % removal
...
PCPA_cost = (PCPA_material_costs + general_energy_cost) / PCPA_removal # USD / % removal
PCPA_impacts = (PCPA_material_impacts + general_energy_impact) / PCPA_removal # impact / % removal
#%% PCPT
...
PCPT_cost = (PCPT_material_costs + general_energy_cost) / PCPT_removal # USD / % removal
PCPT_impacts = (PCPT_material_impacts + general_energy_impact) / PCPT_removal # impact / % removal
...
ax.set_ylabel("Cost \n [USD/% removal]", fontname="Arial", fontsize=12) 
...
# Change the y axis label to Arial
ax.set_ylabel("Acidification potential \n [kg SO2 eq/% removal]", fontname="Arial", fontsize=12) 
...
# Change the y axis label to Arial
ax.set_ylabel("Global warming potential \n [kg CO2 eq/% removal]", fontname="Arial", fontsize=12) 
...
# Change the y axis label to Arial
ax.set_ylabel("Ecotoxicity: freshwater \n [CTUe/% removal]", fontname="Arial", fontsize=12) 
...
# Change the y axis label to Arial
ax.set_ylabel("Eutrophication potential \n [kg N eq/% removal]", fontname="Arial", fontsize=12) 
...
# Change the y axis label to Arial
ax.set_ylabel("Ozone depletion potential \n [kg CFC-11 eq/% removal]", fontname="Arial", fontsize=12) 
...
# Change the y axis label to Arial
ax.set_ylabel("Particulate matter formation \n [kg PM2.5 eq/% removal]", fontname="Arial", fontsize=12) 
